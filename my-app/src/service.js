...
//If you use this on localhost  use this function to get full functionality of register form
export const getAllUsers = () => axios.get('http://localhost:3005/users')

//use this function with json server when you host on GitHub your app through gh-pages ,
